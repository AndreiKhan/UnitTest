...
*/
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        // Assert (Проверка утверждения)
        assertThat(cart.getTotalPrice()).isEqualTo(150+150+150+150+15+15+15);
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        cart.removeProductByID(8);

        // Assert (Проверка утверждения)
        assertThat(cart.getTotalPrice()).isEqualTo(tekPrice - 59);
     ...
     * <br><b>Ожидаемый результат:</b>
     * Исключение типа NoSuchFieldError и сообщение "В корзине не найден продукт с id"
     */
    @Test
